    ...
    <div className="about_info">
      ...
      <div className="about_info__text">
        ...
        <p>
          ...
          always willing to learn new technologies/languages on the job. So far
          I have had experience with freelance work and opensource activity. I'm
          always eager to rise to new challenges and explore new horizons.
        </p>
      </div>
    </div>
