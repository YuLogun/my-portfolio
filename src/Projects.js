    ...
    <div className="projects_container">
      <div className="projects_container__item">
        <div className="projects_container__pic__container">
          <a
            target="_blank"
            href="https://terry-and-neil-quote-machine.herokuapp.com/"
            rel="noopener noreferrer"
          >
            <img
              src={quotePic}
              className="projects_container__item__avatar"
              alt="quoye machine project preview"
            />
          </a>
        </div>
        <div className="projects_container__item__text">
          This is a quote machine (a magic ball project). Ask my 2 favourite
      ...
      <div className="projects_container__item">
        ...
        <div className="projects_container__item__text">
          This is an e-commerce project. I've always been a big fan of geek
